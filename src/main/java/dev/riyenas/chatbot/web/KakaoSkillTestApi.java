...
public class KakaoSkillTestApi {
        ...
        SkillResponse skillResponse = new SkillResponseTemplate()
                ...
                .addBasicCard(BasicCard.of(
                        ...
                        Arrays.asList(
                                ...
                                ButtonEnum.PHONE.action("전화 걸기", "010-1234-5678"),
                                ButtonEnum.WEBLINK.action("이미지 보기", IMAGE_URL)
                        )
                ))
                .addListCard(ListCard.of(
                        ...
                        Arrays.asList(ButtonEnum.WEBLINK.action("홈페이지", HOMEPAGE_URL))
                ))
